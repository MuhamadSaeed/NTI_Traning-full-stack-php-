...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2025 at 10:52 PM
...
(7, 'ali hassanss', 'allihaassan@gmail.com', '01020453180', '2025-07-11'),
...
('mohamed', 'mohamed@g.c', '0000', 0),
('mohamed', 'mo@g.c', '0000', 0),
('Mohamed Saied', 'mohamedsaiedz2156287@gmail.com', '$2y$10$if0nTbK4nO0oiNpBrga23e6k8T8rAksk1cRvA7y7o02.Em7uzDB2e', 0),
('ali', 'ali@g.c', '$2y$10$rK8C5lOiI5qCMzs0hOpzNOIwKumW3UAYJuWO8DQyezeDJTGvMIaAC', 1),
('admin', 'admin@g.c', '0000', 1),
('kh', 'kh@g.g', '$2y$10$ndPxtSjEzIuMiu5tUN7VRO9iAFVBOxsAnWMWSSDz97noe74JE5YDG', 0);
